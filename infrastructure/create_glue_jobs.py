...
def create_glue_job(job_name, role_arn, script_location, bucket_name, project_lib_path, glue_version="4.0", worker_type="Standard", worker_count=2):
    ...
    default_arguments = {
        ...
        "--TempDir": f"s3://{bucket_name}/warehouse/event-driven-cpssw-artifacts/code/temp/{job_name}/",
        "--S3_TARGET_PATH": f"s3://{bucket_name}/warehouse/event-driven-cpssw-artifacts/",
